    ...
    <div class="container mx-auto max-w-3xl">
        ...
        <div class="mb-6 flex justify-between items-center">
            ...
            <button x-show="anyItemSelected" @click="showPreview = true"
                    ...
                    style="display: none;"> <!-- Initially hidden if no items are selected, managed by Alpine x-show -->
                Preview List
            </button>
        </div>
    ...
    <div x-show="showPreview"
        ...
        <div @click.away="showPreview = false" class="bg-white rounded-lg shadow-xl w-full max-w-lg p-6 max-h-[80vh] overflow-y-auto">
            ...
            <div class="mt-6 pt-4 border-t">
                ...
                <div class="mb-4">
                    <label for="shareEmailInput" class="block text-sm font-medium text-gray-700 mb-1">Recipient's Email (optional):</label>
